<aside class="admin-sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <a href="/admin/inventory/ledger" class="sidebar-link {{ request()->is('admin/inventory/ledger') ? 'active' : '' }}">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="nav-section">
            ...
            <a href="/admin/settings/banner" class="sidebar-link {{ request()->is('admin/settings/banner') ? 'active' : '' }}">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="/admin/settings" class="sidebar-link {{ request()->is('admin/settings') && !request()->is('admin/settings/*') ? 'active' : '' }}">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="/admin/settings/email-templates" class="sidebar-link {{ request()->is('admin/settings/email-templates*') ? 'active' : '' }}">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
