...
<div style="background-color:#fff3cd;border:1px solid #ffc107;border-radius:8px;padding:14px 18px;">
<strong style="color:#856404;font-size:14px;">A new order has been placed and requires attention.</strong>
</div>
</td></tr>
...
<tr>
<td style="padding:8px 0;"><span style="color:#6c757d;font-size:13px;">Customer:</span></td>
<td style="padding:8px 0;text-align:right;"><span style="color:#333;font-size:14px;">{{ $user->name }}</span></td>
</tr>
<tr>
