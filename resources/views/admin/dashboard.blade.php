            ...
            <div class="panel-body">
                @if (isset($lowStock) && count($lowStock) > 0)
                    ...
                    <div class="low-stock-item">
                        <img src="{{ !empty($item->product) && !empty($item->product->image) ? asset('storage/' . $item->product->image) : '/assets/images/category-bookshelf.png' }}" alt="{{ $item->product ? $item->product->name : 'Unknown Product' }}" class="low-stock-img" onerror="this.onerror=null;this.src='/assets/images/category-bookshelf.png';">
