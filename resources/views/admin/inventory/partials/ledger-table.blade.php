                    ...
                    <tr>
                        ...
                        <td>
                            <div class="product-cell">
                                <img src="{{ $entry->product ? ($entry->product->image ?? '/assets/images/category-bookshelf.png') : '/assets/images/category-bookshelf.png' }}" alt="{{ $entry->product->name ?? 'Unknown Product' }}" class="product-thumb">
                                <div>
