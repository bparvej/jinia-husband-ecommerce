                    ...
                    <tr>
                        <td>
                            <div class="product-cell">
                                <img src="{{ !empty($product->image) ? asset('storage/' . $product->image) : '/assets/images/category-bookshelf.png' }}" alt="{{ $product->name }}" class="product-thumb" onerror="this.onerror=null;this.src='/assets/images/category-bookshelf.png';">
                                <div>
