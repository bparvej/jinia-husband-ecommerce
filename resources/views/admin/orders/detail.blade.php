                            ...
                            <tr>
                                <td>
                                    <div class="product-cell">
                                        @if ($item->product)
                                        <img src="{{ !empty($item->product->image) ? asset('storage/' . $item->product->image) : '/assets/images/category-bookshelf.png' }}" alt="{{ $item->product_name }}" class="product-thumb" onerror="this.onerror=null;this.src='/assets/images/category-bookshelf.png';">
                                        @endif
