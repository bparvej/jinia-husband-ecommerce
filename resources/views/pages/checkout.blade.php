            ...
            <div class="checkout-product-summary">
                <div class="checkout-product-card">
                    <div class="checkout-product-image">
                        <img src="{{ !empty($product->image) ? asset('storage/' . $product->image) : '/assets/images/category-bookshelf.png' }}" alt="{{ $product->name }}" onerror="this.onerror=null;this.src='/assets/images/category-bookshelf.png';">
                    </div>
